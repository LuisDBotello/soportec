...
public class MotherboardModeloServiceImpl implements MotherboardModeloService {
    ...
    @Override
    public List<MotherboardModelo> findByMarcaMotherboard(Integer idMarcaMotherboard) {
        return repository.findByMarcaMotherboard_IdMarcaMotherboard(idMarcaMotherboard);
    }
}
